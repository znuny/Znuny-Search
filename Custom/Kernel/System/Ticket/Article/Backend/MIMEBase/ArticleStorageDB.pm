...
# --
# $origin: znuny - 460ef44565300c6b979b0743833e3800fdbebf81 - Kernel/System/Ticket/Article/Backend/MIMEBase/ArticleStorageDB.pm
# --
...
# Znuny-Search
# ---
    my $TicketID = $Param{TicketID} || $ArticleObject->TicketIDLookup(
        ArticleID => $Param{ArticleID},
    );

    $Self->EventHandler(
        Event => 'ArticleWriteAttachment',
        Data  => {
            TicketID           => $TicketID,
            ArticleID          => $Param{ArticleID},
            FileID             => $Param{FileID},
            ...
            ContentAlternative => $Param{ContentAlternative},
